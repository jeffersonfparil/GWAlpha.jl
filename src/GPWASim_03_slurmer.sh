...
# EXAMPLE 1:
# ./GPWASim_03_slurmer.sh /data/cephfs/punim0543/jparil 10 0.001 0.25 -0.25 1 32
# EXAMPLE 2:
...
#             ./GPWASim_03_slurmer.sh /data/cephfs/punim0543/jparil ${nqtl} ${mr} ${fgs} ${bgs} ${grad} ${rep} 32
#            done
#         done
#       done
#     done
