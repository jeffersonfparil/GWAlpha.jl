...
echo -e "#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#"
echo -e "GROUPING,ALGORITHM,POP_TRAIN,POP_TEST,MODEL_ITERATION,MODEL_COVARIATE,MODEL_MODEL,PREDICTORS,NON_ZERO_PREDICTORS,MEAN_DEVIANCE,VAR_DEVIANCE,CORRELATION,INTERCEPT,SLOPE,R2,RMSD,TRUE_POSITIVE_RATE,QTL_FRAC_EFF,TRUE_POSITIVE_ID,FALSE_DISCOVERY_ID,FALSE_DISCOVERY_RATE,QTL_FREQS_TRAINING,QTL_FREQS_VALIDATION" \
